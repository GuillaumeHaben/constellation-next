...
export default function AdminApprovalsPage() {
    ...
    const handleApprove = async (pin) => {
        ...
        try {
            ...
            // Update UI by filtering out the approved pin. 
            // We compare against the identifier we used, but the list has the original objects.
            // Best to compare by unique ID available in the list object.
    ...
    const handleReject = async (pin) => {
        ...
        // if (!confirm("Are you sure you want to reject this pin?")) return;
        setProcessing(pin.id);
        const pinIdentifier = pin.documentId || pin.id;
        try {
            const token = localStorage.getItem("token");
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col">
            ...
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 w-full">
                <h1 className="text-3xl font-bold mb-8">Pin Approvals</h1>
